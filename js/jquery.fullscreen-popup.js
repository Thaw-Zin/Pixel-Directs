    ...
    FSP = (function() {
      ...
      FSP.prototype.createWrappers = function() {
        this.mainWrapper = $("<div/>", {
          ...
          "style": this.options.inlineStyles ? "background: " + this.options.bgColor + "; position: fixed; top: 0; left: 0; right: 0; bottom: 0; z-index: 9999; height:100%; overflow-y: scroll; overflow-x: hidden; display: none" : void 0
        });
        this.contentWrapper = $("<div/>", {
          "class": "" + this.options.contentWrapperClass,
          "style": "width: " + this.targetSizes.width + "px; height: " + this.targetSizes.height + "px;  position: absolute; top: 50%; left: 50%; margin-left: -" + (this.targetSizes.width / 2) + "px; margin-top: -" + (this.targetSizes.height / 3) + "px"
        ...
        return this.close = $("<a/>", {
          ...
          "style": this.options.inlineStyles ? "position: fixed; right: 1em; top: 1em; background:#333; color:#fff; padding:0 14px; border-radius:4px; font-size:25px;" : void 0
        }).appendTo(this.mainWrapper);
      };
